...
| Visuotactile sensors ×2 | One per finger, tri-colour visuotactile imaging; the rectified image's export orientation is chosen per project, defaulting to 700 × 400 (landscape), with 400 × 700 rotated 90° counter-clockwise (aligned with the SDK) as the alternative | 120 Hz at the sensor, UVC | The same; the Backpack Kit records at 120 fps and the Developer Kit records at 30 fps by default |
