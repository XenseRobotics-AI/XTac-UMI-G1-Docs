...
flowchart LR
    ...
    subgraph HOST["数采主机 · x86 + NVIDIA GPU"]
        ...
        VR2["XTac-UMI XR PC Service<br/>独立守护进程"]
...
| 位姿服务 | XTac-UMI XR 运行时内置,随背包启动 | XTac-UMI XR PC Service 是独立守护进程,要先起服务再开 App;≥ v0.2.0 还转发[头显双目画面](../pc/recording.md#56) |
