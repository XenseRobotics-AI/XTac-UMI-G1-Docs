...
- **系统**:设备信息、夹爪配置(开合标定与 MCU 固件)、采集设置(采集模式、腕部画面去畸变、录制快捷键、语音播报、灯语与设备按键说明)、上传配置、网络 / 配网、相机参数包、系统更新;纳管页预留给多机管理,当前不需要配置。
...
系统 → 采集设置 → 采集模式 里选这台设备的通道预设,它决定实时布局、录制内容与导出:
