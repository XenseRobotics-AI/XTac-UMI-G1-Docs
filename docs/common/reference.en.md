...
| **XenseVR PC Service / runtime** | The service that receives the headset pose: on the Developer Kit a daemon on the collection PC that you start by hand; on the Backpack Kit built into Collector |
